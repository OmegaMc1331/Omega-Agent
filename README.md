...
- `OMEGA_CODEX_MODE=exec` documente le mode actuel : Omega lance `codex exec` pour chaque tour, avec timeout subprocess, sandbox read-only et workspace scope. Le cout de demarrage est mesure dans les traces.
